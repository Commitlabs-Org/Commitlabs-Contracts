...
| create_commitment(owner, amount, asset_address, rules) -> String      | Creates commitment, transfers assets, mints NFT. | Owner require_auth.                       | Uses reentrancy guard and rate limiting per owner. |
...
| update_value(caller, commitment_id, new_value)                        | Update stored value and check rules.             | Authorized Updater/Admin only.            | Enforces loss limits and updates protocol TVL.     |
...
| early_exit(commitment_id, caller)                                     | Exit early with penalty.                         | Owner require_auth.                       | Uses SafeMath to compute penalty.                  |
| allocate(caller, commitment_id, target_pool, amount)                  | Allocate assets to pool.                         | Authorized Allocator/Allocation Contract/Admin only.          | Transfers assets to target pool.                   |
...
| pause(caller)                                                         | Pause the contract.                              | Authorized Operator/Admin only.           | Uses shared Pausable.                              |
| unpause(caller)                                                       | Unpause the contract.                            | Authorized Operator/Admin only.           | Uses shared Pausable.                              |
| set_emergency_mode(caller, enabled)                                   | Set emergency mode.                              | Authorized Guardian/Admin only.           | Uses shared EmergencyControl.                      |
| emergency_withdraw(caller, asset, to, amount)                         | Emergency asset withdrawal.                      | Authorized Guardian/Admin only.           |                                                    |
| set_creation_fee_bps(caller, bps)                                     | Set creation fee in bps.                         | Authorized Treasurer/Admin only.          |                                                    |
| set_fee_recipient(caller, recipient)                                  | Set treasury address for fees.                   | Authorized Treasurer/Admin only.          |                                                    |
| withdraw_fees(caller, asset, amount)                                  | Withdraw collected fees.                         | Authorized Treasurer/Admin only.          | Transfers to recipient.                            |
| add_allocator(caller, allocator)                                      | Add authorized allocator address.                | Admin only.                               |                                                    |
| remove_allocator(caller, allocator)                                   | Remove authorized allocator address.             | Admin only.                               |                                                    |
| is_allocator(address) -> bool                                         | Check if address is authorized allocator.        | View.                                     |                                                    |
| add_guardian(caller, guardian)                                        | Add authorized guardian address.                 | Admin only.                               |                                                    |
| remove_guardian(caller, guardian)                                     | Remove authorized guardian address.              | Admin only.                               |                                                    |
| is_guardian(address) -> bool                                          | Check if address is authorized guardian.         | View.                                     |                                                    |
| add_treasurer(caller, treasurer)                                      | Add authorized treasurer address.                | Admin only.                               |                                                    |
| remove_treasurer(caller, treasurer)                                   | Remove authorized treasurer address.             | Admin only.                               |                                                    |
| is_treasurer(address) -> bool                                         | Check if address is authorized treasurer.        | View.                                     |                                                    |
| add_operator(caller, operator)                                        | Add authorized operator address.                 | Admin only.                               |                                                    |
| remove_operator(caller, operator)                                     | Remove authorized operator address.              | Admin only.                               |                                                    |
| is_operator(address) -> bool                                          | Check if address is authorized operator.         | View.                                     |                                                    |
| pause(caller)                                                         | Pause the contract.                              | Authorized Operator/Admin only.           | Uses shared Pausable.                              |
| unpause(caller)                                                       | Unpause the contract.                            | Authorized Operator/Admin only.           | Uses shared Pausable.                              |
| set_emergency_mode(caller, enabled)                                   | Set emergency mode.                              | Authorized Guardian/Admin only.           | Uses shared EmergencyControl.                      |
| emergency_withdraw(caller, asset, to, amount)                         | Emergency asset withdrawal.                      | Authorized Guardian/Admin only.           |                                                    |
