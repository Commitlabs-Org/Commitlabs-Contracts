...
impl PriceOracleContract {
    ...
    pub fn get_price_for_marketplace(
        ...
        let data = Self::get_price_valid(e.clone(), asset.clone(), Some(marketplace_staleness))?;
    ...
    pub fn get_price_for_hi_value(
        ...
        let data = Self::get_price_valid(e.clone(), asset.clone(), Some(staleness))?;
